    ...
    <>
      ...
      >
        <div className="flex flex-col h-full relative">
          ...
          {/* Logo */}
          <div
            className={`flex items-center h-16 border-b border-white/10 px-4 ${isCollapsed ? "justify-center" : "justify-between"}`}
          >
            {!isCollapsed && (
              <Link to="/" className="text-xl font-bold text-[oklch(1_0_0)] truncate">
                Centre Culturel
              </Link>
            )}
            {isCollapsed && (
          ...
          <nav className="flex-1 overflow-y-auto py-4 px-3">
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  to="/dashboard/admin"
                  className={`group flex items-center ${isCollapsed ? "justify-center" : ""} px-3 py-2 text-white rounded-lg transition-all duration-200 hover:bg-white/10 relative ${
                    location.pathname === "/dashboard/admin" ? "bg-white/20 font-medium" : ""
                  }`}
              ...
              <li>
                ...
                >
                  ...
                  {!isCollapsed && <span className="ml-3 transition-opacity duration-200">Commentaires</span>}
              ...
              <li>
                <Link
                  ...
                  className={`group flex items-center ${isCollapsed ? "justify-center" : ""} px-3 py-2 text-white rounded-lg transition-all duration-200 hover:bg-white/10 relative ${
                    isActive("/event-proposals") ? "bg-white/20 font-medium" : ""
                  }`}
                  onClick={closeSidebar}
                >
                  <span className="inline-flex items-center justify-center w-6 h-6">
          ...
          <div className={`mt-auto border-t border-white/10 p-4 ${isCollapsed ? "text-center" : ""}`}>
            {!isCollapsed ? (
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-white/60 truncate capitalize">{userRole}</p>
                </div>
                <button
